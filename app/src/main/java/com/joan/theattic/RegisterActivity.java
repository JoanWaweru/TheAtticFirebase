...
public class RegisterActivity extends AppCompatActivity {
        ...
        //Initialize an Instance of Firebase Database reference by calling the database instance, getting a reference using the get reference() method on the database,and creating a new child node, in our case "Users" where we will store details of registered users
...
@Override
        ...
        //set an on click listener on your register button, on clicking this button we want toget: the username, email , password the user enters on edit text fields
// further we to open a new activity called profile activity where will allow our users toset a custom display name and their profile image
        ...
        //Create a new createAccount method that takes in an email address and password, validates them, and then creates a new user with the [createUserWithEmailAndPassword] using the instance of Firebase Authentication (mAuth) We created and calls addOnCompleteListener
